...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef Flechette_Round => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Shotgun_Magazine", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "Flechette Ammo", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
